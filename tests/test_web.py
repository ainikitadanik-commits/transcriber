...
class WebTests(unittest.TestCase):
    ...
    def test_ui_preserves_accessible_contract_and_responsive_guards(self):
        ...
        self.assertIn("let realtimeStopRequested = false", javascript)
        self.assertIn('liveStop.setAttribute("aria-busy"', javascript)
        ...
        self.assertIn("app.css?v=207", html)
        self.assertIn("app.js?v=207", html)
